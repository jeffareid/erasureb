...
plus and minus are XOR, so the generator polynomial can be described as:
...
Package home: https://github.com/jeffareid/ersbch

# build

The C++ code is a single file ersbch.cpp. I use Visual Studio to build it,
but it should be compilable with most compilers.
...
The code benchmarks erasure handling of RS(20,17) in matrix[20][32768], of
which the first 17 row are data, and the last 3 rows are parity.

The defines near the top of the source file can be changed. 
